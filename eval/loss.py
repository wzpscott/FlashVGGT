...
from flash_vggt.utils.pose_enc import extri_intri_to_pose_encoding
...
class MultitaskLoss(torch.nn.Module):
    ...
    def forward(self, predictions, batch) -> torch.Tensor:
        ...
        batch["extrinsics"], batch["cam_coords_points"], batch["world_coords_points"], batch["depths"] = \
            normalize_camera_extrinsics_and_points_batch(
                extrinsics=batch["extrinsics"],
                cam_points=batch["cam_coords_points"],
                world_points=batch["world_coords_points"],
                depths=batch["depths"],
