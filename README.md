...
The training code for FlashVGGT (both single-forward and streaming settings) is available in the `training` branch. Please refer to the [Training README](training/README.md) for detailed instructions on installation, dataset preparation, and training commands.
