...
class Block(nn.Module):
    ...
    def forward(self, x: Tensor, pos=None, pH: int = None, pW: int = None, patch_start_idx: int = None) -> Tensor:
        def attn_residual_func(x: Tensor, pos=None) -> Tensor:
            return self.ls1(self.attn(self.norm1(x), pos=pos, pH=pH, pW=pW, patch_start_idx=patch_start_idx))
